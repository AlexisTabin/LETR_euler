...
#SBATCH --job-name=24h_r101_213_s1
#SBATCH --output=24h_r101_213_s1.out
#SBATCH --error=24h_r101_213_s1.err
...
rm -rf exp/res101_stage1_213_24h/

bash script/train/a1_train_stage1_res101.sh  res101_stage1_213_24h
echo "Done rendering"
