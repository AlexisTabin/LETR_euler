...
if [ ! -d "$output"  ]; then
    ...
    --master_port=$((1000 + RANDOM % 9999)) --nproc_per_node=5 --use_env  src/main.py --coco_path data_normals/ \
    ...
    --batch_size 1 ${@:2} --epochs 300 --lr_drop 120 --num_queries 1000 --num_gpus 5 --wandb_name $name | tee -a $output/history.txt  
