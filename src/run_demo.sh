...
cp $EXP_PATH/a4/checkpoints/checkpoint.pth $EXP_PATH/checkpoints/checkpoint_res50_s2.pth
...
cp ../../LETR_euler_a5/exp/a5/checkpoints/checkpoint.pth $EXP_PATH/checkpoints/checkpoint_res101_s3.pth
