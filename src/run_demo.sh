...
cp $EXP_PATH/res50_stage2_from_a0_with_200_epochs/checkpoints/checkpoint.pth $EXP_PATH/checkpoints/checkpoint_res50_s3.pth
cp $EXP_PATH/res101_stage1_718_24h/checkpoints/checkpoint.pth $EXP_PATH/checkpoints/checkpoint_res101_s1.pth
cp $EXP_PATH/res101_stage2_516_from_a1_with_170_epochs/checkpoints/checkpoint.pth $EXP_PATH/checkpoints/checkpoint_res101_s3.pth
